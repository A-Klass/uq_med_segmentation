"""
Kudos to XiaowenK/UNet_Family
https://github.com/XiaowenK/UNet_Family/blob/master/models/unet.py
...
class UNet(nn.Module):
    ...
    def __init__(self, n_classes, n_channels):
        ...
        # Encoder part.
        self.encoder1 = EncoderBlock(in_channels=n_channels, out_channels=64)
        ...
        # Final part.decoder2
        self.final = FinalBlock(in_channels=128, out_channels=n_classes)
